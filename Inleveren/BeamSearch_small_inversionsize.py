        ...
        for j in templayerTwo:
            ...
            for m in tempLayerThree:
                ...
                if inversionLenm > inversionEndm:
                    inversionEndm -= 1
                    inversionLenm = 2
                # saves the best out of 27000000, adds negative points for total inversion length over all layers
                currentScore = getScoreFromPosition(m) - ((inversionLeni + inversionLenj + inversionLenm))
